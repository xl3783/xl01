...
import { BUSINESS_STATUS, BUSINESS_TYPES } from './shared-domain-library.js';
 ...
 * 船舶访问API接口
 */
export const VESSEL_VISIT_API = {
    // 创建船舶访问
    CREATE: {
        method: 'POST',
        path: '/api/vessel-visits',
        request: {
            vesselId: 'string',
            visitDetails: {
                eta: 'Date',
    ...
    START: {
        method: 'POST',
        path: '/api/vessel-visits/:id/start',
        response: {
            success: 'boolean',
            data: 'object',
            message: 'string',
    ...
    COMPLETE: {
        method: 'POST',
        path: '/api/vessel-visits/:id/complete',
        response: {
            success: 'boolean',
            data: 'object',
            message: 'string',
 ...
 * 积载计划API接口
 */
export const STOWAGE_PLAN_API = {
    // 导入积载计划
    IMPORT: {
        method: 'POST',
        path: '/api/stowage-plans/import',
        request: {
    ...
    EXPORT: {
        method: 'GET',
        path: '/api/stowage-plans/:id/export',
        response: {
            success: 'boolean',
            data: {
                format: 'string',
 ...
 * 作业指令API接口
 */
export const WORK_INSTRUCTION_API = {
    // 创建作业指令
    CREATE: {
        method: 'POST',
        path: '/api/work-instructions',
        request: {
            vesselVisitId: 'string',
    ...
    ISSUE: {
        method: 'POST',
        path: '/api/work-instructions/:id/issue',
        request: {
            issueMethod: 'string'
        },
        response: {
    ...
    START: {
        method: 'POST',
        path: '/api/work-instructions/:id/start',
        response: {
            success: 'boolean',
            data: 'object',
            message: 'string',
    ...
    COMPLETE: {
        method: 'POST',
        path: '/api/work-instructions/:id/complete',
        response: {
            success: 'boolean',
            data: 'object',
            message: 'string',
